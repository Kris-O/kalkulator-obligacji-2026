...
> ⚠️ **Nie używaj "Code → Download ZIP"** z GitHuba — to pobiera całe repozytorium,
> a nie plugin. WordPress odrzuci taki plik. Pobierz dedykowany ZIP poniżej.

**Pobierz:** [`releases/kalkulator-obligacji-wordpress-v1.0.3.zip`](releases/kalkulator-obligacji-wordpress-v1.0.3.zip)

1. Pobierz ZIP powyżej
2. Przejdź do **WordPress → Wtyczki → Dodaj nową → Wyślij wtyczkę**
3. Prześlij ZIP i kliknij **Zainstaluj**, a następnie **Aktywuj**
4. Wklej shortcode na dowolnej stronie:
...
Kalkulator powstał jako open-source'owa reimplementacja arkusza Excel stworzonego przez
**Marcina Iwucia** na blogu [Finanse Bardzo Osobiste](https://marciniwuc.com/):
...
Oryginalny plik Excel (`Kalkulator-obligacji-maj-2026-Finanse-Bardzo-Osobiste.xlsx`) posłużył
jako model referencyjny — wszystkie formuły, parametry i wartości testowe zostały zweryfikowane
1:1 względem arkusza. Marcin regularnie aktualizuje kalkulator wraz ze zmianami oferty PKO BP.
